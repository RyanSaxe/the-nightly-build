# Editor review-brief — tech-news/2026-08-01 (01)
...
- The **exact writer brief**: `agent-artifacts/tech-news/2026-08-01/writer/01/brief.md`
  (read it so copied instructions / prompt leakage into the prose are detectable)
- The draft: `library/tech-news/2026-08-01.html`
- Evidence: `agent-artifacts/tech-news/2026-08-01/researcher/01/evidence.md`
- Voice guide: `agent-artifacts/tech-news/2026-08-01/writing-coach/01/voice-guide.md`
...
- Return to **researcher**: a claim whose evidence is missing, wrong, or
  unverifiable.
- Confirm 4-6 items, each 1 primary + >=1 independent secondary. For any model, re-verify parameter count / license / context window against the PRIMARY card, not aggregators. Significance, not promotion, must justify each item.
## Prove it after your edits
Re-run: `/home/user/the-nightly-build/nb check library/tech-news/2026-08-01.html --series tech-news --repo /home/user/the-nightly-build` and confirm **BLOCK: 0** still holds.

## Output
Write `agent-artifacts/tech-news/2026-08-01/editor/01/editorial-review.md`: the record
of the three reads, every direct edit you made, every source you re-checked and
its result, and your decision.

## Report
- If no required change remains: `DONE editor library/tech-news/2026-08-01.html`
