# Evidence: tech-news/2026-08-06 (researcher 02)

Round-02 change (only): the lead item's sourcing gate is fixed. Editor round 01
correctly found that Candidate 1's two round-01 secondaries were NOT independent of
the authoring parties — Medical Xpress republished a Boston Children's (authoring-site)
press release, and UT Dell Medical School is the study's own "UT-led" institution.
Neither is outside the authoring party, so the per-item primary+independent gate failed.
This round confirms the owning primary is the Nature paper itself and supplies truly
independent, openable accounts (GEN, NPR, Science/AAAS), all dated 2026-08-05. The two
non-independent items are retained but explicitly relabeled so the writer sets
`data-nb-kind` correctly (they support institutional framing, not independence).

All other round-01 records (Candidates 2–5, Contradictions, Numbers, Source assets,
Discarded) are carried forward intact and unchanged.
...
### Candidate 1 — Anellovirus reactivation linked to long COVID (science/health) — FRESH, SOLID — independence FIXED in round 02

```text
URL:         https://www.nature.com/articles/s41586-026-10740-z
Kind:        PRIMARY (the owning primary). The peer-reviewed Nature paper that owns the
             finding and the cohort data. This is the single per-item primary.
...
```text
URL:         https://www.genengnews.com/topics/coronavirus/covid-19-reactivates-dormant-viruses-offering-new-clues-to-long-covid/
Kind:        SECONDARY, TRULY INDEPENDENT. GEN (Genetic Engineering & Biotechnology News)
             staff reporting, byline Julianna LeMieux, PhD, dated 2026-08-05. Outside the
             authoring parties (not Boston Children's, not UT); synthesizes the peer-
             reviewed paper with attributed quotes — not a press release.
Establishes: Independent confirmation of the paper's headline claims: 1,154 patients
             across 20 US biomedical research hospitals; "more than 200,000 samples" and
             "more than one billion data points" over one year; 11 reactivated viruses
             within 40 days (EBV, HSV1, CMV, Anelloviridae most common); Anelloviridae
             reactivation "associated prominently with long-term physical disability and
             long COVID"; and the paper's surprising point that inflammation, not
             immunosuppression, appears to drive reactivation in immunocompetent patients.
Paraphrase:  A specialist newsroom independently restates the cohort scale, the specific
             anellovirus/long-COVID association, and the inflammation-not-suppression
             mechanism, and notes causation remains under investigation.
Locators:    Full article. Confirmed openable (URL resolves to its own GEN page).
```

```text
URL:         https://www.npr.org/2026/08/05/g-s1-137479/long-covid-19
Kind:        SECONDARY, TRULY INDEPENDENT. NPR reporting, byline Rob Stein, dated
             2026-08-05 (1:29 PM ET). Outside the authoring parties.
Establishes: Independent confirmation of timing and scale ("more than 1,100 patients who
             were hospitalized for COVID at 20 hospitals around the country") and the
             finding that COVID "can apparently reactivate other viruses that had been
             dormant"; frames a "family of common viruses that may be associated with
             long-COVID." Note: NPR does not name Anelloviridae explicitly and carries no
             external-expert quote, so it is independent but thinner on specifics than GEN.
Paraphrase:  A general-audience US newsroom independently reports the reactivation finding
             and the cautious "may be associated" framing on the day of publication.
Locators:    Full article. Confirmed openable (URL resolves to its own NPR page).
```

```text
URL:         https://www.science.org/content/article/covid-19-can-wake-dormant-viruses-body-large-study-confirms
Kind:        SECONDARY, TRULY INDEPENDENT. Science/AAAS news article, dated ~2026-08-05.
             Outside the authoring parties. NOTE: returns HTTP 403 to automated fetch
             (gated, not dead); it is Science's own live article page and openable in a
             browser. Recorded as a further independent option; prefer GEN or NPR as the
             writer's citation since both were opened and confirmed openable.
Establishes: A third independent US science newsroom covering the same IMPACC study on
             the same day; corroborates the reactivation finding and the long-COVID link.
Paraphrase:  Science/AAAS independently reports the large-study confirmation.
Locators:    Full article (browser-openable; gated to automated fetch).
```

```text
URL:         https://medicalxpress.com/news/2026-08-severe-covid-reactivates-dormant-viruses.html
Kind:        NOT INDEPENDENT — retained for context only. This is a republished Boston
             Children's (authoring-site) press release, i.e. it originates with an
             authoring party. It supports that the claim was made and gives institutional
             framing; it does NOT satisfy the independent-account gate. The writer must
             not set this as the independent secondary.
Establishes: Institutional framing and restatement of the finding from an authoring party;
             a repetition, not independent confirmation.
...
Kind:        NOT INDEPENDENT — retained for context only. UT Austin Dell Medical School is
             the study's own "UT-led" institution (an authoring party). Useful for naming
             the lead group and confirming the paper's numbers, but it is inside the
             authoring party and does NOT satisfy the independent-account gate.
Establishes: Authoring-institution framing; names the lead group; corroborates cohort
             scale. A repetition from a stakeholder, not independent confirmation.
...
NOTE (provenance): K-EXAONE model-card/report details in this record were gathered from
             aggregated search of the card, the technical report, and independent
             coverage rather than a direct page fetch of the model card; treat as the
             weakest-verified candidate and confirm on the card before publishing.
```
...
- **Print-issue date vs development date (systematic).** Nature Vol 656, Issue 8126 is
  ...
  2026-08-05.
- **Candidate 1 (anellovirus): independence and correlation.** (a) Independence: the two
  round-01 secondaries (Medical Xpress = Boston Children's press release; UT Dell Med =
  authoring institution) are NOT independent; the writer must cite GEN, NPR, or
  Science/AAAS for the independent account. (b) The authors explicitly state the data do
  not establish causation; the association is specifically with *persistent physical
  disability* in the long-COVID subgroup, not with long COVID broadly. Eric Topol's
  public summary and GEN cite ">200,000 samples" / "20 centers"; the paper's own header
  gives 1,154 patients across 20 US hospitals / 15 academic institutes. Use the paper's
  figures; the sample/data-point counts are best attributed to GEN/press framing.
...
```
```text
Figure: 11 reactivated viruses detected within first 40 days; ~200,000 samples; >1 billion data points
Owner:  Reported by GEN (2026-08-05) from the IMPACC study; sample/data-point counts are press/GEN framing, not the paper's abstract figures
Scope:  First 40 days post-admission; whole-cohort measurement effort
```
```text
