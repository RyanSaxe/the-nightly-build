...
A brief works like a wire service. Write for a reader who already saw the
headline and add what it left out: the number, the caveat the headline dropped.

Each item is a judgment about what moved, not a recap. Give the development and
a link to its primary source (the original announcement or paper, over any
...
Source: `press/series/current-events/prompt.md`
