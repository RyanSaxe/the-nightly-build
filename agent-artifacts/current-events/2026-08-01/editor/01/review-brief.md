# Editor review-brief — current-events/2026-08-01 (01)
...
- The **exact writer brief**: `agent-artifacts/current-events/2026-08-01/writer/01/brief.md`
  (read it so copied instructions / prompt leakage into the prose are detectable)
- The draft: `library/current-events/2026-08-01.html`
- Evidence: `agent-artifacts/current-events/2026-08-01/researcher/01/evidence.md`
- Voice guide: `agent-artifacts/current-events/2026-08-01/writing-coach/01/voice-guide.md`
...
- Return to **researcher**: a claim whose evidence is missing, wrong, or
  unverifiable.
- Confirm 4-6 items, each with exactly 1 primary + >=1 independent secondary, headline linking to the primary. Confirm the mail-in voting order is NOT centered (Opinion owns it). Verify every date/figure against the primary.
## Prove it after your edits
Re-run: `/home/user/the-nightly-build/nb check library/current-events/2026-08-01.html --series current-events --repo /home/user/the-nightly-build` and confirm **BLOCK: 0** still holds.

## Output
Write `agent-artifacts/current-events/2026-08-01/editor/01/editorial-review.md`: the record
of the three reads, every direct edit you made, every source you re-checked and
its result, and your decision.

## Report
- If no required change remains: `DONE editor library/current-events/2026-08-01.html`
