...
- `docs/` is the human documentation. Link the relevant page when the user
...
can approve an editorial direction without approving publication or an
external write. State the impending mutation before making it when the user
has not already requested that change.
