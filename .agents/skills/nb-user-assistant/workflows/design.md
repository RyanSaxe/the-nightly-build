...
for "a card" may need an existing note, table, or claim component. A user
asking for "a new template" may need a stronger series prompt. Show that
diagnosis with a representative content example.
