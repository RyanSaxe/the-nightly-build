...
# Nightly Build user assistant adapter

Read and follow the canonical
[user-assistant skill](../../../.agents/skills/nb-user-assistant/SKILL.md).
Resolve every workflow, craft, and reference link from that canonical skill
directory.
