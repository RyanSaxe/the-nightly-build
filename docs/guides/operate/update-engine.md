...
After an update, compare the external scheduler prompt with the canonical
prompt in [Schedule](schedule.md). The schedule lives outside Git and cannot be
updated by a merge. You may also dispatch the publish workflow to rebuild the
back catalog immediately.
