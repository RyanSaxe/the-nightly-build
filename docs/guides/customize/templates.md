...
future articles that lack it. Decide deliberately which structure is invariant
and which stays open to the subject. The
[Template reference](../../reference/templates.md) defines the package
contract and names the shipped templates.
