...
You will make editorial decisions in conversation: what the paper is for, who
it serves, which recurring series it carries, and what excellent output looks
like. The assistant should test those decisions with examples rather than hand
