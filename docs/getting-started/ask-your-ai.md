...
The article goes into Dispatches, the series a fresh paper starts with, and
publishes through a pull request the repository's own check validates and
merges. Add "let me read it first" to your request and the pull request opens as
a draft that waits for you instead.
