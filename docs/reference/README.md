...
| Hold before publish     | Open an asked-for article's PR as a draft that CI validates and nothing merges until you mark it ready                   | `nb prepare-pr --hold`; see [Your first article](../getting-started/first-article.md)                    |
...
| Capability                             | What it supports                                                                                                                                                  | Configure or learn more                                                       |
| -------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| Guided setup                           | Creates the press with its on-demand series, the protected publication branch, workflows, and Pages configuration; prints any setting it cannot make without `gh` | `./nb setup` and [Set up](../getting-started/setup.md)                        |
...
| Scheduled-runtime smoke test           | Verifies `uv`, the checkout-owned CLI, live research access, branch push, draft-PR creation, CI registration, and cleanup without publishing                      | [Verify the scheduled runtime](../guides/operate/verify-scheduled-runtime.md) |
