...
| Capability                             | What it supports                                                                                                                             | Configure or learn more                                                       |
| -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| Guided setup                           | Creates the press, protected publication branch, workflows, and Pages configuration. Prints settings it cannot change without `gh`.          | `./nb setup` and [Set up](../getting-started/setup.md)                        |
