...
| Sections                  | One level of named grouping for the home page, Sections page, and article kickers                    | `section` in `series.yaml`; see [rhythm and shelving](series.md#rhythm-and-shelving)                             |
...
| Capability                | What it supports                                                                                                     | Configure or learn more                                                                              |
| ------------------------- | -------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| Mixed cadences            | Daily, weekdays, weekends, selected UTC weekdays, and manual-only series under one scheduled run                     | `cadence` in `series.yaml`; see [rhythm and shelving](series.md#rhythm-and-shelving)                 |
...
| Optional auto-publication | Auto-merge clean new-article PRs per series; revisions and owner curation always wait for human review               | `autopublish` in `series.yaml` and [Publishing and security](../concepts/publishing-and-security.md) |
...
| Strict mode                   | Promotes every proof warning to a blocking failure for selected series                                                      | `strict` in `series.yaml`                                                                                          |
...
| Required or best-effort routing  | Stop when a model or effort directive cannot be honored, or use the closest available option and record it                 | `required` paper-wide or per stage                                              |
...
| Reusable furniture       | Timelines, comparison grids, evidence cards, pull quotes, rubrics, and custom semantic components  | Shipped `templates/FURNITURE.md` or `press/furniture/`; see [Furniture](../guides/customize/furniture.md)        |
...
| Scheduled-runtime canary               | Immediately tests real web access, model/tool availability, branch push, PR creation, proof, and browser rendering before unattended use | [First run](../getting-started/first-run.md)                             |
