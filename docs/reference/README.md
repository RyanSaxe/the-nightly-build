...
| Capability                             | What it supports                                                                                                                             | Configure or learn more                                                  |
| -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| Guided setup                           | Creates the press with its on-demand series, the protected publication branch, workflows, Pages configuration, and auto-merge setting        | `./nb setup` and [Set up](../getting-started/setup.md)                   |
