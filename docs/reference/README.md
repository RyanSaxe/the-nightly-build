...
| Scheduled-runtime test                 | Immediately tests real web access, model/tool availability, branch push, PR creation, proof, and browser rendering before unattended use | [First run](../getting-started/first-run.md)                             |
