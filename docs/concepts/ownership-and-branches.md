...
direction, production guidance, series, prompt fragments, themes, furniture,
and custom templates. The canonical upstream repository carries no `press/`,
so a user who confines customization to this directory gets a conflict-free
engine update path.
...
artifacts, protected publishing workflows, and the generated Pages site live
there. It changes only through its validated PR boundary.
